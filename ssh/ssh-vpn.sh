...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/scvpn/dotvpn/main/ssh/newudpgw"
...
wget -q https://raw.githubusercontent.com/scvpn/dotvpn/main/ssh/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/scvpn/dotvpn/main/banner/issue.net"
